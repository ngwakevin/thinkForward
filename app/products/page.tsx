...
export default function ProductsPage() {
  return (
      ...
      <section className="relative">
        <div className="mx-auto max-w-5xl">
          <div className="mb-10 text-center space-y-4">
              <h2 className="font-display text-3xl md:text-4xl font-bold tracking-tight bg-gradient-to-r from-accent to-accent-alt text-transparent bg-clip-text">Our Training Options</h2>
    ...
    <h1 className="font-display text-4xl md:text-5xl font-bold tracking-tight bg-gradient-to-r from-accent to-accent-alt text-transparent bg-clip-text">Products</h1>
