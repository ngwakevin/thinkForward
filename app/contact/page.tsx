...
const steps = [
	...
	},
	{
		...
		body: 'In the first call we\'ll explore your needs, current environment, and how Cloudegree can support your outcomes.',
	},
	{
		...
		<div className="mx-auto max-w-7xl px-6 py-24 space-y-24">
			<header className="space-y-6">
				...
				<p className="text-fg-muted max-w-2xl text-sm md:text-base leading-relaxed">
					Discover how Cloudegree accelerates cloud & DevOps capability building, reduces ramp time, and creates durable engineering momentum. Share a few details and we&apos;ll respond within one business day.
				</p>
			...
			<section className="border-t border-border/70 pt-16">
				<h2 className="font-display text-xl font-semibold tracking-tight mb-4">Need Direct Support?</h2>
				<p className="text-sm md:text-base text-fg-muted max-w-2xl leading-relaxed">
					If you have an urgent platform issue, account question, or security concern you can email us directly at{' '}
					<a href="mailto:support@cloudegree.com" className="text-accent underline underline-offset-4 decoration-accent/40 hover:decoration-accent">
						support@cloudegree.com
					</a>. We aim to respond within 1 business day (faster for availability / security notices).
				</p>
				<ul className="mt-6 grid gap-6 sm:grid-cols-2 max-w-3xl text-xs md:text-sm">
					<li className="rounded-lg border border-border/60 bg-bg-alt/40 p-4">
						<h3 className="font-medium mb-1 text-fg">Best for</h3>
						<p className="text-fg-muted leading-relaxed">Account access issues, billing questions, reporting a bug, vulnerability disclosure.</p>
					</li>
					<li className="rounded-lg border border-border/60 bg-bg-alt/40 p-4">
						<h3 className="font-medium mb-1 text-fg">Include</h3>
						<p className="text-fg-muted leading-relaxed">A concise subject, affected URL or feature, and any relevant error text / reproduction steps.</p>
					</li>
				</ul>
			</section>
		</div>
