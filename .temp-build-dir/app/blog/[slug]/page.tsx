...
import { CopyPermalinkButton } from '../../../components/blog/CopyPermalinkButton';
  ...
  return (
    <>
      ...
      <article className="mx-auto max-w-3xl px-6 py-24 relative">
        ...
        <div className="mt-8 flex gap-3 text-xs text-fg-muted flex-wrap items-center">
          <span>Share:</span>
          ...
          <CopyPermalinkButton url={canonical} />
        </div>
