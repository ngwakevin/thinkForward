...
const steps = [
	...
	},
	{
		...
		body: 'In the first call we\'ll explore your needs, current environment, and how CloudAcers can support your outcomes.',
	},
	{
		...
		<div className="mx-auto max-w-7xl px-6 py-24 space-y-24">
			<header className="space-y-6">
				...
				<p className="text-fg-muted max-w-2xl text-sm md:text-base leading-relaxed">
					Discover how CloudAcers accelerates cloud & DevOps capability building, reduces ramp time, and creates durable engineering momentum. Share a few details and we&apos;ll respond within one business day.
				</p>
