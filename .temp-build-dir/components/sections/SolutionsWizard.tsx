...
export function SolutionsWizard() {
  ...
  <h3 className="font-display text-xl font-semibold tracking-tight bg-gradient-to-r from-accent to-accent-alt text-transparent bg-clip-text">Choose Your Path</h3>
