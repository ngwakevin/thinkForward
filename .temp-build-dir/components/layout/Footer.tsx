      ...
      <div className="mx-auto max-w-7xl px-6 pt-24">
        ...
        <div className="text-center">
          <Link href="/" className="inline-block focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/40 rounded-sm">
            <AttachedLogo className="inline-flex items-center gap-2 text-3xl" text="CloudAcers" />
          </Link>
        ...
        <div className="mt-14 flex flex-col items-center gap-6">
          <div className="flex gap-5 text-white/60">
            <a href="https://twitter.com/cloudacers" aria-label="Twitter" className="hover:text-white transition" rel="noopener noreferrer" target="_blank">
          ...
          <div className="text-xs text-white/50">© {year} CloudAcers • Built for sustained velocity</div>
        </div>
      </div>
    </footer>
  );
