...
export function TestimonialsSlice() {
  const customFirst = 'A clear roadmap and quick feedback turned a year of wandering into just a few months of real progress. Thank you, Cloudegree team!';
  const customSecond = 'Just one session was all I needed to focus on what truly matters and get a perfect roadmap. Thank you, Cloudegree team!';
  const customThird = 'Thanks to the one-on-one session, I stayed focused and on track. Thank you, Cloudegree team!';
  return (
    <section className="relative py-24">
      <div aria-hidden className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-accent/40 via-accent-alt/30 to-accent/40" />
