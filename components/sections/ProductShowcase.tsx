      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 max-w-3xl space-y-5">
          <p className="text-[12px] font-semibold uppercase tracking-wide text-accent">Learning Engine</p>
            <h2 className="font-display text-4xl md:text-5xl font-bold tracking-tight bg-gradient-to-r from-accent to-accent-alt text-transparent bg-clip-text">How We Accelerate Your Cloud Career</h2>
