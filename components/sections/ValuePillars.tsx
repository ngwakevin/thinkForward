				...
				{/* Copy + cards */}
					...
					<div className="space-y-6 max-w-xl">
					  ...
					  <div className="relative">
						  {/* animated cloud shapes (subtle) */}
									<div aria-hidden className="pointer-events-none absolute -z-10 inset-0">
										<div className="absolute left-[-30px] top-[-20px] h-40 w-64 rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.08),transparent_60%)] blur-3xl animate-float-slowest" />
										<div className="absolute right-[10%] top-[10%] h-32 w-52 rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.07),transparent_60%)] blur-2xl animate-float-slowest" />
										<div className="absolute left-[30%] bottom-[-10%] h-36 w-60 rounded-full bg-[radial-gradient(circle,rgba(255,255,255,0.06),transparent_60%)] blur-3xl animate-float-slowest" />
									</div>
