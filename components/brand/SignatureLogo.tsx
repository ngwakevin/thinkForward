...
/**
 * SignatureLogo: Unified "Cloudegree" wordmark with:
...
export function SignatureLogo({
  ...
  const gradId = useId();
  return (
  <span className={`relative inline-flex items-baseline font-display font-semibold tracking-tight ${className}`} aria-label="Cloudegree">
      {/* Cloud + Cloud text */}
