...
export const LogoIcon: React.FC<LogoIconProps> = ({
  ...
  return (
    ...
    >
      ...
      {variant === 'outline' ? (
        <path
          d="M43.5 27.5c-.9-6-6.1-10.5-12.3-10.5-4.6 0-8.7 2.5-10.9 6.3-5.3.4-9.5 4.8-9.5 10.3 0 5.7 4.6 10.4 10.4 10.4h27.3c5.1 0 9.2-4.1 9.2-9.2 0-4.8-3.7-8.7-8.4-9.3Z"
          fill="none"
        ...
        <path
          ...
          opacity={variant === 'mono' ? 0.18 : 1}
        />
      )}

      {/* Upward "A" chevron (center) */}
      <path
        d="M22 43l10-18 10 18m-16.5-3.5h13"
        fill="none"
...
export const LogoLockup: React.FC<LogoLockupProps> = ({
  ...
  return (
    <span className={className} aria-label="CloudAcers logo">
...
export const AltLogoIcon: React.FC<LogoIconProps> = ({
  ...
  return (
    <svg viewBox="0 0 120 40" role="img" aria-labelledby={titleId} className={className} {...props}>
      ...
      {/* Cloud glyph */}
      <path
        d="M26 18c-.6-4.1-4.2-7.2-8.5-7.2-3.2 0-6 1.7-7.5 4.3-3.6.3-6.5 3.2-6.5 6.9 0 3.8 3.1 6.9 6.9 6.9H27c3.4 0 6.1-2.7 6.1-6.1 0-3.2-2.4-5.8-5.5-6.1Z"
        fill={variant === 'mono' ? 'currentColor' : `url(#${gradId})`}
        opacity={variant === 'mono' ? 0.2 : 1}
      />
      {/* Floating dot */}
      <circle cx="33" cy="8" r="3" fill={variant === 'mono' ? 'currentColor' : `url(#${gradId})`} />
      {/* Angle bracket accent */}
      <path d="M98 12 L112 20 L98 28" fill="none" stroke="hsl(38, 90%, 60%)" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
...
export const AltLogoLockup: React.FC<LogoLockupProps> = ({
  ...
  return (
    <span className={className} aria-label="CloudAcers logo alt">
...
export const CALigatureLockup: React.FC<LogoLockupProps> = ({
  ...
  return (
    <span className={className} aria-label="CloudAcers CA ligature">
...
export const ApexLogoLockup: React.FC<LogoLockupProps> = ({
  ...
  return (
    <span className={className} aria-label="CloudAcers Apex lockup">
...
export const MomentumLogoLockup: React.FC<LogoLockupProps> = ({
  ...
  return (
    <span className={className} aria-label="CloudAcers Momentum lockup">
...
export const ProLogoLockup: React.FC<LogoLockupProps> = ({
  ...
  return (
    <span className={className} aria-label="CloudAcers professional lockup">
